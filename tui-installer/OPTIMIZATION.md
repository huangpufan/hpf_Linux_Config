...
### 3.1 ✅ ~~asyncio.get_event_loop() 已弃用~~ (已修复)
...
| 当前文件名 | 实际功能 | 状态 |
|------------|----------|----------|
| ~~`git-install.sh`~~ → `fzf-install.sh` | 安装 FZF | ✅ 已重命名 |
