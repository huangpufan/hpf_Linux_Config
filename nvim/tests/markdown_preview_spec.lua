...
assert(css:find "padding: 0 1%.75em", "reading CSS body gutter")
assert(css:find "position: absolute", "heading anchors should not shift heading text")
assert(css:find "right: 100%%", "heading anchors should live in the body gutter")
assert(css:find "margin%-left: 0", "heading anchors should not pull text across the body border")
